...
pub fn build(b: *std.Build) void {
    ...
    // Library module
    const json_patch_mod = b.addModule("json_patch", .{
    ...
    const basic_exe = b.addExecutable(.{
        .name = "json-patch-basic",
        .root_source_file = b.path("examples/basic.zig"),
        .target = target,
        .optimize = optimize,
    });
    basic_exe.root_module.addImport("json_patch", json_patch_mod);
    ...
    const advanced_exe = b.addExecutable(.{
        .name = "json-patch-advanced",
        .root_source_file = b.path("examples/advanced.zig"),
        .target = target,
        .optimize = optimize,
    });
    advanced_exe.root_module.addImport("json_patch", json_patch_mod);
