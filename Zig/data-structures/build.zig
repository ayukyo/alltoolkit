...
pub fn build(b: *std.Build) void {
    ...
    // Library module
    const ds_mod = b.addModule("data-structures", .{
    ...
    basic_exe.root_module.addImport("data-structures", ds_mod);
    ...
    advanced_exe.root_module.addImport("data-structures", ds_mod);
